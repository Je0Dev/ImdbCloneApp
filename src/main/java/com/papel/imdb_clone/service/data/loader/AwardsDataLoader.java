...
public class AwardsDataLoader extends BaseDataLoader {
    ...
    private final InMemoryMovieRepository movieRepository;//for movies
    private final InMemorySeriesRepository seriesRepository;//for series
    private final MoviesService moviesService;//for movies service
    private final SeriesService seriesService;//for series service
     ...
     */
    public AwardsDataLoader(InMemoryMovieRepository movieRepository, InMemorySeriesRepository seriesRepository, MoviesService moviesService, SeriesService seriesService) {
