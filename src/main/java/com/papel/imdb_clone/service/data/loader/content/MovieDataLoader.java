...
public class MovieDataLoader extends BaseDataLoader {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MovieDataLoader.class);//logger
    private final MoviesService movieService;//movie service
    private final CelebrityService<Actor> actorService;//actor service for movieService instance
    private final CelebrityService<Director> directorService;//director service for directorService instance
    ...
    private String normalizeText(String text) {
        ...
        // Fix common encoding issues for some names to be able to be loaded correctly
        return text.trim()
                .replace("Ac", "é")// Fix ChloAc -> Chloé
                .replace("Ae", "é") // Fix ChloAc -> Chloé
                        ...
                        try {
                            ...
                            for (String actorName : actorNames) {
                                ...
                                try {
                                    ...
                                    // Continue with next actor again
                                }
                            }
    ...
    private static String getString(String genreName) {
        //normalize genre name to make the parsing easier
        ...
        // Special case handling for common variations-could add more
