...
public class ActorDataLoader extends BaseDataLoader {
        ...
        try (InputStream inputStream = getResourceAsStream(filename);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    // Parse birthdate with better error handling and fallback
                    ...
                    if (birthDateStr.isEmpty() || birthDateStr.equalsIgnoreCase("n/a")) {
                        ...
                        // Generate a default birthdate with some variation
                        ...
                        try {
                            ...
                            LocalDate maxBirthDate = now.plusYears(1); // Allow for timezone issues which means that the date can be in the future

                            // Adjust birthdate if it's out of range
                    ...
                    try {
                        ...
                        Actor actor = Actor.getInstance(
                            firstName, lastName, birthDate, gender, ethnicity
                        );
            ...
            //time it took for the actors to be loaded
    ...
    /**
     * Parses the gender from the input parts.
     * @param parts the input parts
     * @return the gender character
     */
    private static char getGender(String[] parts) {
